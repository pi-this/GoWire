...
Center Square
    ...
    "movement"
    # Create a button to show the selected items
    up = tk.Button(root, text="↑", command=lambda: move_up(root, label_map, frame_map, special1, special2, special3, listbox), bg='black', foreground='white', font = ('Sans','15','bold'))
    up.place(x=823-490-270, y=430+25+15)

    # Create a button to show the selected items
    down = tk.Button(root, text="↓", command=lambda: move_down(root, label_map, frame_map, special1, special2, special3, listbox), bg='black', foreground='white', font = ('Sans','15','bold'))
    down.place(x=823-490-270, y=430+100-25+15)

    # Create a button to show the selected items
    left = tk.Button(root, text="←", command=lambda: move_left(root, label_map, frame_map, special1, special2, special3, listbox), bg='black', foreground='white', font = ('Sans','15','bold'))
    left.place(x=823-490-80+10+27-270, y=430+50+15)

    # Create a button to show the selected items
    right = tk.Button(root, text="→", command=lambda: move_right(root, label_map, frame_map, special1, special2, special3, listbox), bg='black', foreground='white', font = ('Sans','15','bold'))
    ...
    canvas2 = tk.Frame(root, width=180, height=160, bg="light gray", bd=1, relief="solid")
    ...
    imageChar = Image.open(image_path)
    imageChar = image.resize((180, 160))  # Resize the image to fit the frame
    photoChar = ImageTk.PhotoImage(imageChar)

    # Create a label to hold the image
    label_char = Label(canvas2, image=photoChar)
    label_char.image = photo  # Keep a reference to avoid garbage collection
    label_char.pack()
...
def move_up():
    ...
    update(root, label_map, frame_map, special1, special2, special3, listbox)
...
def placeCheck():
    ...
    if place == "center":
        ...
        if char == "Captain_Droid.png":
            ...
            special1 = tk.Button(root, text="Find Help", command=special1_center, bg='light gray', foreground='black', width=25)
            ...
            special1 = tk.Button(root, text="Hack Closest Robot", command=special1_center, bg='light gray', foreground='black', width=25)
            special1.place(x=20, y=450+150)
            ...
            special1 = tk.Button(root, text="Make a Deal", command=special1_center, bg='light gray', foreground='black', width=25)
            special1.place(x=20, y=450+150)
