...
def newDay():
    ...
    while True:
        placeCurrent = place
        time.sleep(0.2)  # Wait for 60 seconds
        # 1 minute = 1 day
...
def open_main_window_HackBot():
    ...
    # -10 is really 0 because +10 is added at start of game in update every time
...
def open_main_window_Medicoid():
    ...
    batteryType = "-5%/d"
    heat = 0 # too much heat is bad for robot
    # must be 0 because +10 is added in update
...
def special1_center():
    global text_info, scroll_text, dayTime
    # find help
    update()
